import java.io.*;
public class RailwayReservationAndTicketingSystem {
    ...
    double pay[] = new double[50];
    double change[] = new double[50];
    
    for(int i=1;i<4;){
		System.out.println("Welcome to Railway Login, Please Enter Credential to Login");
		...
		//store 50 seats every destination [1-5]//
    	for(int o=1; o<=6; o++){
    		available[o]=50;
  		}
    
    	//if user and password are correct proceed to MAIN MENU//
    	if(user.equals("Railway") && password.equals("Admin123")){
    		...
    		for(int x=1; x==1;){
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("***************************************");
						System.out.println("** 1.)LUCKNOW    | Rs.600 |   "+available[1]+"   **");
    					System.out.println("** 2.)CHENNAI    | Rs.250 |   "+available[5]+"   **");
						System.out.println("** 3.)GWALIOR  	 | Rs.170 |   "+available[2]+"   **");
    					System.out.println("** 4.)MIRZAPUR   | Rs.150 |   "+available[3]+"   **");
    					System.out.println("** 5.)KANPUR     | Rs.200 |   "+available[4]+"   **");
    					System.out.println("** 6.)MUMBAI     | Rs.500 |   "+available[6]+"   **");
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
					...
					//if CHOICE is "2" proceed to Ticket Booking//
    					...
    					String dest[] = { " ", "LUCKNOW", "CHENNAI", "GWALIOR", "MIRZAPUR", "KANPUR","MUMBAI"};
    					double fare[] = { 0,600,170,150,200,250,500};
    			...
    			for(y=1; y==1;){
    				...
    				System.out.print("Do you Wish to Enter Reservation Wizard? [Y/N]: ");
   				 	yn = in.readLine();
